 ...
 */var vg;function u1(){if(vg)return Yo;vg=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function n(a,o,c){var u=null;if(c!==void 0&&(u=""+c),o.key!==void 0&&(u=""+o.key),"key"in o){c={};for(var h in o)h!=="key"&&(c[h]=o[h])}else c=o;return o=c.ref,{$$typeof:s,type:a,key:u,ref:o!==void 0?o:null,props:c}}return Yo.Fragment=t,Yo.jsx=n,Yo.jsxs=n,Yo}var _g;function f1(){return _g||(_g=1,Dh.exports=u1()),Dh.exports}var _=f1(),Lh={exports:{}},de={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 *
 * @license MIT
 */var Rg="popstate";function S1(s={}){function t(o,c){let{pathname:u="/",search:h="",hash:m=""}=js(o.location.hash.substring(1));return!u.startsWith("/")&&!u.startsWith(".")&&(u="/"+u),bd("",{pathname:u,search:h,hash:m},c.state&&c.state.usr||null,c.state&&c.state.key||"default")}function n(o,c){let u=o.document.querySelector("base"),h="";if(u&&u.getAttribute("href")){let m=o.location.href,p=m.indexOf("#");h=p===-1?m:m.slice(0,p)}return h+"#"+(typeof c=="string"?c:ul(c))}function a(o,c){Si(o.pathname.charAt(0)==="/",`relative pathnames are not supported in hash history.push(${JSON.stringify(c)})`)}return E1(t,n,a,s)}function an(s,t){if(s===!1||s===null||typeof s>"u")throw new Error(t)}function Si(s,t){if(!s){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function M1(){return Math.random().toString(36).substring(2,10)}function Cg(s,t){return{usr:s.state,key:s.key,idx:t}}function bd(s,t,n=null,a){return{pathname:typeof s=="string"?s:s.pathname,search:"",hash:"",...typeof t=="string"?js(t):t,state:n,key:t&&t.key||a||M1()}}function ul({pathname:s="/",search:t="",hash:n=""}){return t&&t!=="?"&&(s+=t.charAt(0)==="?"?t:"?"+t),n&&n!=="#"&&(s+=n.charAt(0)==="#"?n:"#"+n),s}function js(s){let t={};if(s){let n=s.indexOf("#");n>=0&&(t.hash=s.substring(n),s=s.substring(0,n));let a=s.indexOf("?");a>=0&&(t.search=s.substring(a),s=s.substring(0,a)),s&&(t.pathname=s)}return t}function E1(s,t,n,a={}){let{window:o=document.defaultView,v5Compat:c=!1}=a,u=o.history,h="POP",m=null,p=g();p==null&&(p=0,u.replaceState({...u.state,idx:p},""));function g(){return(u.state||{idx:null}).idx}function x(){h="POP";let M=g(),y=M==null?null:M-p;p=M,m&&m({action:h,location:A.location,delta:y})}function v(M,y){h="PUSH";let z=bd(A.location,M,y);n&&n(z,M),p=g()+1;let R=Cg(z,p),O=A.createHref(z);try{u.pushState(R,"",O)}catch(B){if(B instanceof DOMException&&B.name==="DataCloneError")throw B;o.location.assign(O)}c&&m&&m({action:h,location:A.location,delta:1})}function S(M,y){h="REPLACE";let z=bd(A.location,M,y);n&&n(z,M),p=g();let R=Cg(z,p),O=A.createHref(z);u.replaceState(R,"",O),c&&m&&m({action:h,location:A.location,delta:0})}function E(M){return T1(M)}let A={get action(){return h},get location(){return s(o,u)},listen(M){if(m)throw new Error("A history only accepts one active listener");return o.addEventListener(Rg,x),m=M,()=>{o.removeEventListener(Rg,x),m=null}},createHref(M){return t(o,M)},createURL:E,encodeLocation(M){let y=E(M);return{pathname:y.pathname,search:y.search,hash:y.hash}},push:v,replace:S,go(M){return u.go(M)}};return A}function T1(s,t=!1){let n="http://localhost";typeof window<"u"&&(n=window.location.origin!=="null"?window.location.origin:window.location.href),an(n,"No window.location.(origin|href) available to create URL");let a=typeof s=="string"?s:ul(s);return a=a.replace(/ $/,"%20"),!t&&a.startsWith("//")&&(a=n+a),new URL(a,n)}function Wv(s,t,n="/"){return A1(s,t,n,!1)}function A1(s,t,n,a){let o=typeof t=="string"?js(t):t,c=Ta(o.pathname||"/",n);if(c==null)return null;let u=qv(s);w1(u);let h=null;for(let m=0;h==null&&m<u.length;++m){let p=I1(c);h=z1(u[m],p,a)}return h}function qv(s,t=[],n=[],a="",o=!1){let c=(u,h,m=o,p)=>{let g={relativePath:p===void 0?u.path||"":p,caseSensitive:u.caseSensitive===!0,childrenIndex:h,route:u};if(g.relativePath.startsWith("/")){if(!g.relativePath.startsWith(a)&&m)return;an(g.relativePath.startsWith(a),`Absolute route path "${g.relativePath}" nested under path "${a}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),g.relativePath=g.relativePath.slice(a.length)}let x=ba([a,g.relativePath]),v=n.concat(g);u.children&&u.children.length>0&&(an(u.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${x}".`),qv(u.children,t,v,x,m)),!(u.path==null&&!u.index)&&t.push({path:x,score:O1(x,u.index),routesMeta:v})};return s.forEach((u,h)=>{var m;if(u.path===""||!((m=u.path)!=null&&m.includes("?")))c(u,h);else for(let p of Yv(u.path))c(u,h,!0,p)}),t}function Yv(s){let t=s.split("/");if(t.length===0)return[];let[n,...a]=t,o=n.endsWith("?"),c=n.replace(/\?$/,"");if(a.length===0)return o?[c,""]:[c];let u=Yv(a.join("/")),h=[];return h.push(...u.map(m=>m===""?c:[c,m].join("/"))),o&&h.push(...u),h.map(m=>s.startsWith("/")&&m===""?"/":m)}function w1(s){s.sort((t,n)=>t.score!==n.score?n.score-t.score:P1(t.routesMeta.map(a=>a.childrenIndex),n.routesMeta.map(a=>a.childrenIndex)))}var R1=/^:[\w-]+$/,C1=3,N1=2,D1=1,L1=10,U1=-2,Ng=s=>s==="*";function O1(s,t){let n=s.split("/"),a=n.length;return n.some(Ng)&&(a+=U1),t&&(a+=N1),n.filter(o=>!Ng(o)).reduce((o,c)=>o+(R1.test(c)?C1:c===""?D1:L1),a)}function P1(s,t){return s.length===t.length&&s.slice(0,-1).every((a,o)=>a===t[o])?s[s.length-1]-t[t.length-1]:0}function z1(s,t,n=!1){let{routesMeta:a}=s,o={},c="/",u=[];for(let h=0;h<a.length;++h){let m=a[h],p=h===a.length-1,g=c==="/"?t:t.slice(c.length)||"/",x=pu({path:m.relativePath,caseSensitive:m.caseSensitive,end:p},g),v=m.route;if(!x&&p&&n&&!a[a.length-1].route.index&&(x=pu({path:m.relativePath,caseSensitive:m.caseSensitive,end:!1},g)),!x)return null;Object.assign(o,x.params),u.push({params:o,pathname:ba([c,x.pathname]),pathnameBase:k1(ba([c,x.pathnameBase])),route:v}),x.pathnameBase!=="/"&&(c=ba([c,x.pathnameBase]))}return u}function pu(s,t){typeof s=="string"&&(s={path:s,caseSensitive:!1,end:!0});let[n,a]=F1(s.path,s.caseSensitive,s.end),o=t.match(n);if(!o)return null;let c=o[0],u=c.replace(/(.)\/+$/,"$1"),h=o.slice(1);return{params:a.reduce((p,{paramName:g,isOptional:x},v)=>{if(g==="*"){let E=h[v]||"";u=c.slice(0,c.length-E.length).replace(/(.)\/+$/,"$1")}const S=h[v];return x&&!S?p[g]=void 0:p[g]=(S||"").replace(/%2F/g,"/"),p},{}),pathname:c,pathnameBase:u,pattern:s}}function F1(s,t=!1,n=!0){Si(s==="*"||!s.endsWith("*")||s.endsWith("/*"),`Route path "${s}" will be treated as if it were "${s.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${s.replace(/\*$/,"/*")}".`);let a=[],o="^"+s.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(u,h,m)=>(a.push({paramName:h,isOptional:m!=null}),m?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return s.endsWith("*")?(a.push({paramName:"*"}),o+=s==="*"||s==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?o+="\\/*$":s!==""&&s!=="/"&&(o+="(?:(?=\\/|$))"),[new RegExp(o,t?void 0:"i"),a]}function I1(s){try{return s.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return Si(!1,`The URL path "${s}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),s}}function Ta(s,t){if(t==="/")return s;if(!s.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,a=s.charAt(n);return a&&a!=="/"?null:s.slice(n)||"/"}var B1=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,H1=s=>B1.test(s);function V1(s,t="/"){let{pathname:n,search:a="",hash:o=""}=typeof s=="string"?js(s):s,c;if(n)if(H1(n))c=n;else{if(n.includes("//")){let u=n;n=n.replace(/\/\/+/g,"/"),Si(!1,`Pathnames cannot have embedded double slashes - normalizing ${u} -> ${n}`)}n.startsWith("/")?c=Dg(n.substring(1),"/"):c=Dg(n,t)}else c=t;return{pathname:c,search:j1(a),hash:X1(o)}}function Dg(s,t){let n=t.replace(/\/+$/,"").split("/");return s.split("/").forEach(o=>{o===".."?n.length>1&&n.pop():o!=="."&&n.push(o)}),n.length>1?n.join("/"):"/"}function Fh(s,t,n,a){return`Cannot include a '${s}' character in a manually specified \`to.${t}\` field [${JSON.stringify(a)}].  Please separate it out to the \`to.${n}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function G1(s){return s.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function Zv(s){let t=G1(s);return t.map((n,a)=>a===t.length-1?n.pathname:n.pathnameBase)}function Kv(s,t,n,a=!1){let o;typeof s=="string"?o=js(s):(o={...s},an(!o.pathname||!o.pathname.includes("?"),Fh("?","pathname","search",o)),an(!o.pathname||!o.pathname.includes("#"),Fh("#","pathname","hash",o)),an(!o.search||!o.search.includes("#"),Fh("#","search","hash",o)));let c=s===""||o.pathname==="",u=c?"/":o.pathname,h;if(u==null)h=n;else{let x=t.length-1;if(!a&&u.startsWith("..")){let v=u.split("/");for(;v[0]==="..";)v.shift(),x-=1;o.pathname=v.join("/")}h=x>=0?t[x]:"/"}let m=V1(o,h),p=u&&u!=="/"&&u.endsWith("/"),g=(c||u===".")&&n.endsWith("/");return!m.pathname.endsWith("/")&&(p||g)&&(m.pathname+="/"),m}var ba=s=>s.join("/").replace(/\/\/+/g,"/"),k1=s=>s.replace(/\/+$/,"").replace(/^\/*/,"/"),j1=s=>!s||s==="?"?"":s.startsWith("?")?s:"?"+s,X1=s=>!s||s==="#"?"":s.startsWith("#")?s:"#"+s;function W1(s){return s!=null&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.internal=="boolean"&&"data"in s}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var Qv=["POST","PUT","PATCH","DELETE"];new Set(Qv);var q1=["GET",...Qv];new Set(q1);var Zr=dt.createContext(null);Zr.displayName="DataRouter";var vu=dt.createContext(null);vu.displayName="DataRouterState";dt.createContext(!1);var Jv=dt.createContext({isTransitioning:!1});Jv.displayName="ViewTransition";var Y1=dt.createContext(new Map);Y1.displayName="Fetchers";var Z1=dt.createContext(null);Z1.displayName="Await";var ki=dt.createContext(null);ki.displayName="Navigation";var _l=dt.createContext(null);_l.displayName="Location";var wa=dt.createContext({outlet:null,matches:[],isDataRoute:!1});wa.displayName="Route";var vp=dt.createContext(null);vp.displayName="RouteError";function K1(s,{relative:t}={}){an(yl(),"useHref() may be used only in the context of a <Router> component.");let{basename:n,navigator:a}=dt.useContext(ki),{hash:o,pathname:c,search:u}=bl(s,{relative:t}),h=c;return n!=="/"&&(h=c==="/"?n:ba([n,c])),a.createHref({pathname:h,search:u,hash:o})}function yl(){return dt.useContext(_l)!=null}function Ra(){return an(yl(),"useLocation() may be used only in the context of a <Router> component."),dt.useContext(_l).location}var $v="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function t_(s){dt.useContext(ki).static||dt.useLayoutEffect(s)}function Q1(){let{isDataRoute:s}=dt.useContext(wa);return s?uS():J1()}function J1(){an(yl(),"useNavigate() may be used only in the context of a <Router> component.");let s=dt.useContext(Zr),{basename:t,navigator:n}=dt.useContext(ki),{matches:a}=dt.useContext(wa),{pathname:o}=Ra(),c=JSON.stringify(Zv(a)),u=dt.useRef(!1);return t_(()=>{u.current=!0}),dt.useCallback((m,p={})=>{if(Si(u.current,$v),!u.current)return;if(typeof m=="number"){n.go(m);return}let g=Kv(m,JSON.parse(c),o,p.relative==="path");s==null&&t!=="/"&&(g.pathname=g.pathname==="/"?t:ba([t,g.pathname])),(p.replace?n.replace:n.push)(g,p.state,p)},[t,n,c,o,s])}dt.createContext(null);function bl(s,{relative:t}={}){let{matches:n}=dt.useContext(wa),{pathname:a}=Ra(),o=JSON.stringify(Zv(n));return dt.useMemo(()=>Kv(s,JSON.parse(o),a,t==="path"),[s,o,a,t])}function $1(s,t){return e_(s,t)}function e_(s,t,n,a,o){var z;an(yl(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:c}=dt.useContext(ki),{matches:u}=dt.useContext(wa),h=u[u.length-1],m=h?h.params:{},p=h?h.pathname:"/",g=h?h.pathnameBase:"/",x=h&&h.route;{let R=x&&x.path||"";n_(p,!x||R.endsWith("*")||R.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${p}" (under <Route path="${R}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${R}"> to <Route path="${R==="/"?"*":`${R}/*`}">.`)}let v=Ra(),S;if(t){let R=typeof t=="string"?js(t):t;an(g==="/"||((z=R.pathname)==null?void 0:z.startsWith(g)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${g}" but pathname "${R.pathname}" was given in the \`location\` prop.`),S=R}else S=v;let E=S.pathname||"/",A=E;if(g!=="/"){let R=g.replace(/^\//,"").split("/");A="/"+E.replace(/^\//,"").split("/").slice(R.length).join("/")}let M=Wv(s,{pathname:A});Si(x||M!=null,`No routes matched location "${S.pathname}${S.search}${S.hash}" `),Si(M==null||M[M.length-1].route.element!==void 0||M[M.length-1].route.Component!==void 0||M[M.length-1].route.lazy!==void 0,`Matched leaf route at location "${S.pathname}${S.search}${S.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let y=aS(M&&M.map(R=>Object.assign({},R,{params:Object.assign({},m,R.params),pathname:ba([g,c.encodeLocation?c.encodeLocation(R.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:R.pathname]),pathnameBase:R.pathnameBase==="/"?g:ba([g,c.encodeLocation?c.encodeLocation(R.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:R.pathnameBase])})),u,n,a,o);return t&&y?dt.createElement(_l.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...S},navigationType:"POP"}},y):y}function tS(){let s=cS(),t=W1(s)?`${s.status} ${s.statusText}`:s instanceof Error?s.message:JSON.stringify(s),n=s instanceof Error?s.stack:null,a="rgba(200,200,200, 0.5)",o={padding:"0.5rem",backgroundColor:a},c={padding:"2px 4px",backgroundColor:a},u=null;return console.error("Error handled by React Router default ErrorBoundary:",s),u=dt.createElement(dt.Fragment,null,dt.createElement("p",null,"💿 Hey developer 👋"),dt.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",dt.createElement("code",{style:c},"ErrorBoundary")," or"," ",dt.createElement("code",{style:c},"errorElement")," prop on your route.")),dt.createElement(dt.Fragment,null,dt.createElement("h2",null,"Unexpected Application Error!"),dt.createElement("h3",{style:{fontStyle:"italic"}},t),n?dt.createElement("pre",{style:o},n):null,u)}var eS=dt.createElement(tS,null),nS=class extends dt.Component{constructor(s){super(s),this.state={location:s.location,revalidation:s.revalidation,error:s.error}}static getDerivedStateFromError(s){return{error:s}}static getDerivedStateFromProps(s,t){return t.location!==s.location||t.revalidation!=="idle"&&s.revalidation==="idle"?{error:s.error,location:s.location,revalidation:s.revalidation}:{error:s.error!==void 0?s.error:t.error,location:t.location,revalidation:s.revalidation||t.revalidation}}componentDidCatch(s,t){this.props.onError?this.props.onError(s,t):console.error("React Router caught the following error during render",s)}render(){return this.state.error!==void 0?dt.createElement(wa.Provider,{value:this.props.routeContext},dt.createElement(vp.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function iS({routeContext:s,match:t,children:n}){let a=dt.useContext(Zr);return a&&a.static&&a.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(a.staticContext._deepestRenderedBoundaryId=t.route.id),dt.createElement(wa.Provider,{value:s},n)}function aS(s,t=[],n=null,a=null,o=null){if(s==null){if(!n)return null;if(n.errors)s=n.matches;else if(t.length===0&&!n.initialized&&n.matches.length>0)s=n.matches;else return null}let c=s,u=n==null?void 0:n.errors;if(u!=null){let g=c.findIndex(x=>x.route.id&&(u==null?void 0:u[x.route.id])!==void 0);an(g>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(u).join(",")}`),c=c.slice(0,Math.min(c.length,g+1))}let h=!1,m=-1;if(n)for(let g=0;g<c.length;g++){let x=c[g];if((x.route.HydrateFallback||x.route.hydrateFallbackElement)&&(m=g),x.route.id){let{loaderData:v,errors:S}=n,E=x.route.loader&&!v.hasOwnProperty(x.route.id)&&(!S||S[x.route.id]===void 0);if(x.route.lazy||E){h=!0,m>=0?c=c.slice(0,m+1):c=[c[0]];break}}}let p=n&&a?(g,x)=>{var v,S;a(g,{location:n.location,params:((S=(v=n.matches)==null?void 0:v[0])==null?void 0:S.params)??{},errorInfo:x})}:void 0;return c.reduceRight((g,x,v)=>{let S,E=!1,A=null,M=null;n&&(S=u&&x.route.id?u[x.route.id]:void 0,A=x.route.errorElement||eS,h&&(m<0&&v===0?(n_("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),E=!0,M=null):m===v&&(E=!0,M=x.route.hydrateFallbackElement||null)));let y=t.concat(c.slice(0,v+1)),z=()=>{let R;return S?R=A:E?R=M:x.route.Component?R=dt.createElement(x.route.Component,null):x.route.element?R=x.route.element:R=g,dt.createElement(iS,{match:x,routeContext:{outlet:g,matches:y,isDataRoute:n!=null},children:R})};return n&&(x.route.ErrorBoundary||x.route.errorElement||v===0)?dt.createElement(nS,{location:n.location,revalidation:n.revalidation,component:A,error:S,children:z(),routeContext:{outlet:null,matches:y,isDataRoute:!0},onError:p}):z()},null)}function _p(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function sS(s){let t=dt.useContext(Zr);return an(t,_p(s)),t}function rS(s){let t=dt.useContext(vu);return an(t,_p(s)),t}function oS(s){let t=dt.useContext(wa);return an(t,_p(s)),t}function yp(s){let t=oS(s),n=t.matches[t.matches.length-1];return an(n.route.id,`${s} can only be used on routes that contain a unique "id"`),n.route.id}function lS(){return yp("useRouteId")}function cS(){var a;let s=dt.useContext(vp),t=rS("useRouteError"),n=yp("useRouteError");return s!==void 0?s:(a=t.errors)==null?void 0:a[n]}function uS(){let{router:s}=sS("useNavigate"),t=yp("useNavigate"),n=dt.useRef(!1);return t_(()=>{n.current=!0}),dt.useCallback(async(o,c={})=>{Si(n.current,$v),n.current&&(typeof o=="number"?s.navigate(o):await s.navigate(o,{fromRouteId:t,...c}))},[s,t])}var Lg={};function n_(s,t,n){!t&&!Lg[s]&&(Lg[s]=!0,Si(!1,n))}dt.memo(fS);function fS({routes:s,future:t,state:n,unstable_onError:a}){return e_(s,void 0,n,a,t)}function os(s){an(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function hS({basename:s="/",children:t=null,location:n,navigationType:a="POP",navigator:o,static:c=!1}){an(!yl(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let u=s.replace(/^\/*/,"/"),h=dt.useMemo(()=>({basename:u,navigator:o,static:c,future:{}}),[u,o,c]);typeof n=="string"&&(n=js(n));let{pathname:m="/",search:p="",hash:g="",state:x=null,key:v="default"}=n,S=dt.useMemo(()=>{let E=Ta(m,u);return E==null?null:{location:{pathname:E,search:p,hash:g,state:x,key:v},navigationType:a}},[u,m,p,g,x,v,a]);return Si(S!=null,`<Router basename="${u}"> is not able to match the URL "${m}${p}${g}" because it does not start with the basename, so the <Router> won't render anything.`),S==null?null:dt.createElement(ki.Provider,{value:h},dt.createElement(_l.Provider,{children:t,value:S}))}function dS({children:s,location:t}){return $1(Sd(s),t)}function Sd(s,t=[]){let n=[];return dt.Children.forEach(s,(a,o)=>{if(!dt.isValidElement(a))return;let c=[...t,o];if(a.type===dt.Fragment){n.push.apply(n,Sd(a.props.children,c));return}an(a.type===os,`[${typeof a.type=="string"?a.type:a.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),an(!a.props.index||!a.props.children,"An index route cannot have child routes.");let u={id:a.props.id||c.join("-"),caseSensitive:a.props.caseSensitive,element:a.props.element,Component:a.props.Component,index:a.props.index,path:a.props.path,middleware:a.props.middleware,loader:a.props.loader,action:a.props.action,hydrateFallbackElement:a.props.hydrateFallbackElement,HydrateFallback:a.props.HydrateFallback,errorElement:a.props.errorElement,ErrorBoundary:a.props.ErrorBoundary,hasErrorBoundary:a.props.hasErrorBoundary===!0||a.props.ErrorBoundary!=null||a.props.errorElement!=null,shouldRevalidate:a.props.shouldRevalidate,handle:a.props.handle,lazy:a.props.lazy};a.props.children&&(u.children=Sd(a.props.children,c)),n.push(u)}),n}var su="get",ru="application/x-www-form-urlencoded";function _u(s){return s!=null&&typeof s.tagName=="string"}function pS(s){return _u(s)&&s.tagName.toLowerCase()==="button"}function mS(s){return _u(s)&&s.tagName.toLowerCase()==="form"}function xS(s){return _u(s)&&s.tagName.toLowerCase()==="input"}function gS(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function vS(s,t){return s.button===0&&(!t||t==="_self")&&!gS(s)}var Oc=null;function _S(){if(Oc===null)try{new FormData(document.createElement("form"),0),Oc=!1}catch{Oc=!0}return Oc}var yS=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Ih(s){return s!=null&&!yS.has(s)?(Si(!1,`"${s}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${ru}"`),null):s}function bS(s,t){let n,a,o,c,u;if(mS(s)){let h=s.getAttribute("action");a=h?Ta(h,t):null,n=s.getAttribute("method")||su,o=Ih(s.getAttribute("enctype"))||ru,c=new FormData(s)}else if(pS(s)||xS(s)&&(s.type==="submit"||s.type==="image")){let h=s.form;if(h==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let m=s.getAttribute("formaction")||h.getAttribute("action");if(a=m?Ta(m,t):null,n=s.getAttribute("formmethod")||h.getAttribute("method")||su,o=Ih(s.getAttribute("formenctype"))||Ih(h.getAttribute("enctype"))||ru,c=new FormData(h,s),!_S()){let{name:p,type:g,value:x}=s;if(g==="image"){let v=p?`${p}.`:"";c.append(`${v}x`,"0"),c.append(`${v}y`,"0")}else p&&c.append(p,x)}}else{if(_u(s))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');n=su,a=null,o=ru,u=s}return c&&o==="text/plain"&&(u=c,c=void 0),{action:a,method:n.toLowerCase(),encType:o,formData:c,body:u}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function bp(s,t){if(s===!1||s===null||typeof s>"u")throw new Error(t)}function SS(s,t,n){let a=typeof s=="string"?new URL(s,typeof window>"u"?"server://singlefetch/":window.location.origin):s;return a.pathname==="/"?a.pathname=`_root.${n}`:t&&Ta(a.pathname,t)==="/"?a.pathname=`${t.replace(/\/$/,"")}/_root.${n}`:a.pathname=`${a.pathname.replace(/\/$/,"")}.${n}`,a}async function MS(s,t){if(s.id in t)return t[s.id];try{let n=await import(s.module);return t[s.id]=n,n}catch(n){return console.error(`Error loading route module \`${s.module}\`, reloading page...`),console.error(n),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function ES(s){return s==null?!1:s.href==null?s.rel==="preload"&&typeof s.imageSrcSet=="string"&&typeof s.imageSizes=="string":typeof s.rel=="string"&&typeof s.href=="string"}async function TS(s,t,n){let a=await Promise.all(s.map(async o=>{let c=t.routes[o.route.id];if(c){let u=await MS(c,n);return u.links?u.links():[]}return[]}));return CS(a.flat(1).filter(ES).filter(o=>o.rel==="stylesheet"||o.rel==="preload").map(o=>o.rel==="stylesheet"?{...o,rel:"prefetch",as:"style"}:{...o,rel:"prefetch"}))}function Ug(s,t,n,a,o,c){let u=(m,p)=>n[p]?m.route.id!==n[p].route.id:!0,h=(m,p)=>{var g;return n[p].pathname!==m.pathname||((g=n[p].route.path)==null?void 0:g.endsWith("*"))&&n[p].params["*"]!==m.params["*"]};return c==="assets"?t.filter((m,p)=>u(m,p)||h(m,p)):c==="data"?t.filter((m,p)=>{var x;let g=a.routes[m.route.id];if(!g||!g.hasLoader)return!1;if(u(m,p)||h(m,p))return!0;if(m.route.shouldRevalidate){let v=m.route.shouldRevalidate({currentUrl:new URL(o.pathname+o.search+o.hash,window.origin),currentParams:((x=n[0])==null?void 0:x.params)||{},nextUrl:new URL(s,window.origin),nextParams:m.params,defaultShouldRevalidate:!0});if(typeof v=="boolean")return v}return!0}):[]}function AS(s,t,{includeHydrateFallback:n}={}){return wS(s.map(a=>{let o=t.routes[a.route.id];if(!o)return[];let c=[o.module];return o.clientActionModule&&(c=c.concat(o.clientActionModule)),o.clientLoaderModule&&(c=c.concat(o.clientLoaderModule)),n&&o.hydrateFallbackModule&&(c=c.concat(o.hydrateFallbackModule)),o.imports&&(c=c.concat(o.imports)),c}).flat(1))}function wS(s){return[...new Set(s)]}function RS(s){let t={},n=Object.keys(s).sort();for(let a of n)t[a]=s[a];return t}function CS(s,t){let n=new Set;return new Set(t),s.reduce((a,o)=>{let c=JSON.stringify(RS(o));return n.has(c)||(n.add(c),a.push({key:c,link:o})),a},[])}function i_(){let s=dt.useContext(Zr);return bp(s,"You must render this element inside a <DataRouterContext.Provider> element"),s}function NS(){let s=dt.useContext(vu);return bp(s,"You must render this element inside a <DataRouterStateContext.Provider> element"),s}var Sp=dt.createContext(void 0);Sp.displayName="FrameworkContext";function a_(){let s=dt.useContext(Sp);return bp(s,"You must render this element inside a <HydratedRouter> element"),s}function DS(s,t){let n=dt.useContext(Sp),[a,o]=dt.useState(!1),[c,u]=dt.useState(!1),{onFocus:h,onBlur:m,onMouseEnter:p,onMouseLeave:g,onTouchStart:x}=t,v=dt.useRef(null);dt.useEffect(()=>{if(s==="render"&&u(!0),s==="viewport"){let A=y=>{y.forEach(z=>{u(z.isIntersecting)})},M=new IntersectionObserver(A,{threshold:.5});return v.current&&M.observe(v.current),()=>{M.disconnect()}}},[s]),dt.useEffect(()=>{if(a){let A=setTimeout(()=>{u(!0)},100);return()=>{clearTimeout(A)}}},[a]);let S=()=>{o(!0)},E=()=>{o(!1),u(!1)};return n?s!=="intent"?[c,v,{}]:[c,v,{onFocus:Ko(h,S),onBlur:Ko(m,E),onMouseEnter:Ko(p,S),onMouseLeave:Ko(g,E),onTouchStart:Ko(x,S)}]:[!1,v,{}]}function Ko(s,t){return n=>{s&&s(n),n.defaultPrevented||t(n)}}function LS({page:s,...t}){let{router:n}=i_(),a=dt.useMemo(()=>Wv(n.routes,s,n.basename),[n.routes,s,n.basename]);return a?dt.createElement(OS,{page:s,matches:a,...t}):null}function US(s){let{manifest:t,routeModules:n}=a_(),[a,o]=dt.useState([]);return dt.useEffect(()=>{let c=!1;return TS(s,t,n).then(u=>{c||o(u)}),()=>{c=!0}},[s,t,n]),a}function OS({page:s,matches:t,...n}){let a=Ra(),{manifest:o,routeModules:c}=a_(),{basename:u}=i_(),{loaderData:h,matches:m}=NS(),p=dt.useMemo(()=>Ug(s,t,m,o,a,"data"),[s,t,m,o,a]),g=dt.useMemo(()=>Ug(s,t,m,o,a,"assets"),[s,t,m,o,a]),x=dt.useMemo(()=>{if(s===a.pathname+a.search+a.hash)return[];let E=new Set,A=!1;if(t.forEach(y=>{var R;let z=o.routes[y.route.id];!z||!z.hasLoader||(!p.some(O=>O.route.id===y.route.id)&&y.route.id in h&&((R=c[y.route.id])!=null&&R.shouldRevalidate)||z.hasClientLoader?A=!0:E.add(y.route.id))}),E.size===0)return[];let M=SS(s,u,"data");return A&&E.size>0&&M.searchParams.set("_routes",t.filter(y=>E.has(y.route.id)).map(y=>y.route.id).join(",")),[M.pathname+M.search]},[u,h,a,o,p,t,s,c]),v=dt.useMemo(()=>AS(g,o),[g,o]),S=US(g);return dt.createElement(dt.Fragment,null,x.map(E=>dt.createElement("link",{key:E,rel:"prefetch",as:"fetch",href:E,...n})),v.map(E=>dt.createElement("link",{key:E,rel:"modulepreload",href:E,...n})),S.map(({key:E,link:A})=>dt.createElement("link",{key:E,nonce:n.nonce,...A})))}function PS(...s){return t=>{s.forEach(n=>{typeof n=="function"?n(t):n!=null&&(n.current=t)})}}var s_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{s_&&(window.__reactRouterVersion="7.9.6")}catch{}function zS({basename:s,children:t,window:n}){let a=dt.useRef();a.current==null&&(a.current=S1({window:n,v5Compat:!0}));let o=a.current,[c,u]=dt.useState({action:o.action,location:o.location}),h=dt.useCallback(m=>{dt.startTransition(()=>u(m))},[u]);return dt.useLayoutEffect(()=>o.listen(h),[o,h]),dt.createElement(hS,{basename:s,children:t,location:c.location,navigationType:c.action,navigator:o})}var r_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,bn=dt.forwardRef(function({onClick:t,discover:n="render",prefetch:a="none",relative:o,reloadDocument:c,replace:u,state:h,target:m,to:p,preventScrollReset:g,viewTransition:x,...v},S){let{basename:E}=dt.useContext(ki),A=typeof p=="string"&&r_.test(p),M,y=!1;if(typeof p=="string"&&A&&(M=p,s_))try{let D=new URL(window.location.href),N=p.startsWith("//")?new URL(D.protocol+p):new URL(p),G=Ta(N.pathname,E);N.origin===D.origin&&G!=null?p=G+N.search+N.hash:y=!0}catch{Si(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let z=K1(p,{relative:o}),[R,O,B]=DS(a,v),P=HS(p,{replace:u,state:h,target:m,preventScrollReset:g,relative:o,viewTransition:x});function I(D){t&&t(D),D.defaultPrevented||P(D)}let Z=dt.createElement("a",{...v,...B,href:M||z,onClick:y||c?t:I,ref:PS(S,O),target:m,"data-discover":!A&&n==="render"?"true":void 0});return R&&!A?dt.createElement(dt.Fragment,null,Z,dt.createElement(LS,{page:z})):Z});bn.displayName="Link";var FS=dt.forwardRef(function({"aria-current":t="page",caseSensitive:n=!1,className:a="",end:o=!1,style:c,to:u,viewTransition:h,children:m,...p},g){let x=bl(u,{relative:p.relative}),v=Ra(),S=dt.useContext(vu),{navigator:E,basename:A}=dt.useContext(ki),M=S!=null&&XS(x)&&h===!0,y=E.encodeLocation?E.encodeLocation(x).pathname:x.pathname,z=v.pathname,R=S&&S.navigation&&S.navigation.location?S.navigation.location.pathname:null;n||(z=z.toLowerCase(),R=R?R.toLowerCase():null,y=y.toLowerCase()),R&&A&&(R=Ta(R,A)||R);const O=y!=="/"&&y.endsWith("/")?y.length-1:y.length;let B=z===y||!o&&z.startsWith(y)&&z.charAt(O)==="/",P=R!=null&&(R===y||!o&&R.startsWith(y)&&R.charAt(y.length)==="/"),I={isActive:B,isPending:P,isTransitioning:M},Z=B?t:void 0,D;typeof a=="function"?D=a(I):D=[a,B?"active":null,P?"pending":null,M?"transitioning":null].filter(Boolean).join(" ");let N=typeof c=="function"?c(I):c;return dt.createElement(bn,{...p,"aria-current":Z,className:D,ref:g,style:N,to:u,viewTransition:h},typeof m=="function"?m(I):m)});FS.displayName="NavLink";var IS=dt.forwardRef(({discover:s="render",fetcherKey:t,navigate:n,reloadDocument:a,replace:o,state:c,method:u=su,action:h,onSubmit:m,relative:p,preventScrollReset:g,viewTransition:x,...v},S)=>{let E=kS(),A=jS(h,{relative:p}),M=u.toLowerCase()==="get"?"get":"post",y=typeof h=="string"&&r_.test(h),z=R=>{if(m&&m(R),R.defaultPrevented)return;R.preventDefault();let O=R.nativeEvent.submitter,B=(O==null?void 0:O.getAttribute("formmethod"))||u;E(O||R.currentTarget,{fetcherKey:t,method:B,navigate:n,replace:o,state:c,relative:p,preventScrollReset:g,viewTransition:x})};return dt.createElement("form",{ref:S,method:M,action:A,onSubmit:a?m:z,...v,"data-discover":!y&&s==="render"?"true":void 0})});IS.displayName="Form";function BS(s){return`${s} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function o_(s){let t=dt.useContext(Zr);return an(t,BS(s)),t}function HS(s,{target:t,replace:n,state:a,preventScrollReset:o,relative:c,viewTransition:u}={}){let h=Q1(),m=Ra(),p=bl(s,{relative:c});return dt.useCallback(g=>{if(vS(g,t)){g.preventDefault();let x=n!==void 0?n:ul(m)===ul(p);h(s,{replace:x,state:a,preventScrollReset:o,relative:c,viewTransition:u})}},[m,h,p,n,a,t,s,o,c,u])}var VS=0,GS=()=>`__${String(++VS)}__`;function kS(){let{router:s}=o_("useSubmit"),{basename:t}=dt.useContext(ki),n=lS();return dt.useCallback(async(a,o={})=>{let{action:c,method:u,encType:h,formData:m,body:p}=bS(a,t);if(o.navigate===!1){let g=o.fetcherKey||GS();await s.fetch(g,n,o.action||c,{preventScrollReset:o.preventScrollReset,formData:m,body:p,formMethod:o.method||u,formEncType:o.encType||h,flushSync:o.flushSync})}else await s.navigate(o.action||c,{preventScrollReset:o.preventScrollReset,formData:m,body:p,formMethod:o.method||u,formEncType:o.encType||h,replace:o.replace,state:o.state,fromRouteId:n,flushSync:o.flushSync,viewTransition:o.viewTransition})},[s,t,n])}function jS(s,{relative:t}={}){let{basename:n}=dt.useContext(ki),a=dt.useContext(wa);an(a,"useFormAction must be used inside a RouteContext");let[o]=a.matches.slice(-1),c={...bl(s||".",{relative:t})},u=Ra();if(s==null){c.search=u.search;let h=new URLSearchParams(c.search),m=h.getAll("index");if(m.some(g=>g==="")){h.delete("index"),m.filter(x=>x).forEach(x=>h.append("index",x));let g=h.toString();c.search=g?`?${g}`:""}}return(!s||s===".")&&o.route.index&&(c.search=c.search?c.search.replace(/^\?/,"?index&"):"?index"),n!=="/"&&(c.pathname=c.pathname==="/"?n:ba([n,c.pathname])),ul(c)}function XS(s,{relative:t}={}){let n=dt.useContext(Jv);an(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:a}=o_("useViewTransitionState"),o=bl(s,{relative:t});if(!n.isTransitioning)return!1;let c=Ta(n.currentLocation.pathname,a)||n.currentLocation.pathname,u=Ta(n.nextLocation.pathname,a)||n.nextLocation.pathname;return pu(o.pathname,u)!=null||pu(o.pathname,c)!=null}/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const WS=s=>s.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),qS=s=>s.replace(/^([A-Z])|[\s-_]+(\w)/g,(t,n,a)=>a?a.toUpperCase():n.toLowerCase()),Og=s=>{const t=qS(s);return t.charAt(0).toUpperCase()+t.slice(1)},l_=(...s)=>s.filter((t,n,a)=>!!t&&t.trim()!==""&&a.indexOf(t)===n).join(" ").trim(),YS=s=>{for(const t in s)if(t.startsWith("aria-")||t==="role"||t==="title")return!0};/**
 * @license lucide-react v0.555.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`)}function Iw(s,t){let n;switch(t){case a3:n="Linear";break;case s3:n="Reinhard";break;case r3:n="Cineon";break;case o3:n="ACESFilmic";break;case c3:n="AgX";break;case u3:n="Neutral";break;case l3:n="Custom";break;default:pe("WebGLProgram: Unsupported toneMapping:",t),n="Linear"}return"vec3 "+s+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const iu=new X;function Bw(){Pe.getLuminanceCoefficients(iu);const s=iu.x.toFixed(4),t=iu.y.toFixed(4),n=iu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function Yw(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===x_?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===FM?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ga&&(t="SHADOWMAP_TYPE_VSM"),t}function Zw(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case jr:case Xr:t="ENVMAP_TYPE_CUBE";break;case yu:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Kw(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Xr:t="ENVMAP_MODE_REFRACTION";break}return t}function Qw(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case g_:t="ENVMAP_BLENDING_MULTIPLY";break;case n3:t="ENVMAP_BLENDING_MIX";break;case i3:t="ENVMAP_BLENDING_ADD";break}return t}function Jw(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const n=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:a,maxMip:n}}function $w(s,t,n,a){const o=s.getContext(),c=n.defines;let u=n.vertexShader,h=n.fragmentShader;const m=Yw(n),p=Zw(n),g=Kw(n),x=Qw(n),v=Jw(n),S=Hw(n),E=Vw(c),A=o.createProgram();let M,y,z=n.glslVersion?"#version "+n.glslVersion+`
